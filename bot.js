...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = ['-help',`Im on ${client.guilds.size} servers`,,' Muders The Best ','Mo3GzZa'];
    var i = -1;
    var j = 0;
...
client.on('message', function(msg) {
 ...
 client.on('message', message => {
   if (message.content.startsWith("-cuttweet")) {
                if(!message.channel.guild) return message.reply('** This Muders only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL)
...
client.on("message", message => {
    if (message.content === "-rules") {
     ...
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`
 ✧▬▬▬▬▬▬✦ஜ۩۞۩ஜ✧▬▬▬▬▬▬✦
:shield: | Muders Official Discord Rules | :shield:
✧▬▬▬▬▬▬✦ஜ۩۞۩ஜ✧▬▬▬▬▬▬✦
...
✧▬▬▬▬▬▬✦ஜ۩۞۩ஜ✧▬▬▬▬▬▬✦
:beginner: | Admin's Rules | :beginner: 
✧▬▬▬▬▬▬✦ஜ۩۞۩ஜ✧▬▬▬▬▬▬✦
